...
// Turn settings
#define B_BINDING_TURNS             GEN_4 // In Gen5+, binding moves last for 4-5 turns instead of 2-5 turns. (With Grip Claw, 7 and 5 turns respectively.)
...
#define B_SLEEP_CLAUSE                  FALSE      // If TRUE, enables Sleep Clause all the time in every case, overriding B_FLAG_SLEEP_CLAUSE. Use that for modularity.
...
#define B_POOL_RULE_SPECIES_CLAUSE          TRUE     // Only pick a single Pokémon of a unique NatDex number
