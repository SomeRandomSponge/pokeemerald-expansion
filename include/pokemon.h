...
enum MonData {
    ...
    MON_DATA_SHEEN,
    MON_DATA_OT_GENDER,
    MON_DATA_COOL_RIBBON, //removed
    MON_DATA_BEAUTY_RIBBON, //removed
    MON_DATA_CUTE_RIBBON, //removed
    MON_DATA_SMART_RIBBON, //removed
    MON_DATA_TOUGH_RIBBON, //removed
    MON_DATA_LEVEL,
    MON_DATA_MAX_HP,
    MON_DATA_ATK,
    MON_DATA_DEF,
    ...
    MON_DATA_IVS,
    MON_DATA_CHAMPION_RIBBON, //removed
    MON_DATA_WINNING_RIBBON, //removed
    MON_DATA_VICTORY_RIBBON, //removed
    MON_DATA_ARTIST_RIBBON, //removed
    MON_DATA_EFFORT_RIBBON, //removed
    MON_DATA_MARINE_RIBBON, //removed
    MON_DATA_LAND_RIBBON, //removed
    MON_DATA_SKY_RIBBON, //removed
    MON_DATA_COUNTRY_RIBBON, //removed
    MON_DATA_NATIONAL_RIBBON, //removed
    MON_DATA_EARTH_RIBBON, //removed
    MON_DATA_WORLD_RIBBON, //removed
    MON_DATA_MODERN_FATEFUL_ENCOUNTER, //removed
    MON_DATA_KNOWN_MOVES,
    MON_DATA_RIBBON_COUNT, //removed
    MON_DATA_RIBBONS, //removed
    MON_DATA_HYPER_TRAINED_HP, //removed
    MON_DATA_HYPER_TRAINED_ATK, //removed
    MON_DATA_HYPER_TRAINED_DEF, //removed
    MON_DATA_HYPER_TRAINED_SPEED, //removed
    MON_DATA_HYPER_TRAINED_SPATK, //removed
    MON_DATA_HYPER_TRAINED_SPDEF, //removed
    MON_DATA_IS_SHADOW, //removed
...
struct BoxPokemon
{
    ...
    u8 nickname[min(10, POKEMON_NAME_LENGTH)]; // 10 letter nickname
    ...
    u8 otName[PLAYER_NAME_LENGTH]; // 7 letter name.
    u8 markings:4;
