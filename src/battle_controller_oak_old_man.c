...
static const u8 sText_ForPetesSake[] = _("{SPEAKER NAME_OAK}Oh, for Pete's sake…\nSo pushy, as always.\p{B_PLAYER_NAME}.\pYou've never had a POKéMON battle\nbefore, have you?\pA POKéMON battle is when TRAINERS\npit their POKéMON against each\lother.\p");
static const u8 sText_HowDissapointing[] = _("{SPEAKER NAME_OAK}Hm…\nHow disappointing…\pIf you win, you earn prize money,\nand your POKéMON grow.\pBut if you lose, {B_PLAYER_NAME}, you end\nup paying prize money…\pHowever, since you had no warning\nthis time, I'll pay for you.\pBut things won't be this way once\nyou step outside these doors.\pThat's why you must strengthen your\nPOKéMON by battling wild POKéMON.\p");
static const u8 sText_InflictingDamageIsKey[] = _("{SPEAKER NAME_OAK}Inflicting damage on the foe\nis the key to any battle.\p");
static const u8 sText_KeepAnEyeOnHP[] = _("{SPEAKER NAME_OAK}Keep your eyes on your\nPOKéMON's HP.\pIt will faint if the HP drops to\n“0.”\p");
static const u8 sText_LoweringStats[] = _("{SPEAKER NAME_OAK}Lowering the foe's stats\nwill put you at an advantage.\p");
static const u8 sText_OakNoRunningFromATrainer[] = _("{SPEAKER NAME_OAK}No! There's no running away\nfrom a TRAINER POKéMON battle!\p");
...
static const u8 sText_WinEarnsPrizeMoney[] = _("{SPEAKER NAME_OAK}Hm! Excellent!\pIf you win, you earn prize money,\nand your POKéMON will grow!\pBattle other TRAINERS and make\nyour POKéMON strong!\p");
