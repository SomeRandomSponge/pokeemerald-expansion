...
static const enum NationalDexOrder sKantoToNationalOrder[KANTO_DEX_COUNT] =
{
    ...
    KANTO_TO_NATIONAL(NIDORAN_MALE),
    KANTO_TO_NATIONAL(NIDORINO_J),
    KANTO_TO_NATIONAL(NIDOKING_J),
#if P_NEW_EVOS_IN_REGIONAL_DEX && P_GEN_2_CROSS_EVOS
...
#endif
    KANTO_TO_NATIONAL(NIMBEON),
    KANTO_TO_NATIONAL(TITANEON),
